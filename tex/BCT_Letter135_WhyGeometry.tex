...
\item \textbf{D4 is the densest lattice packing} of spheres in four 
dimensions, proven by Korkine and Zolotareff~\cite{korkine} in 1877. 
(The unrestricted packing problem in $\mathbb{R}^4$ remains open.) Maximum 
...
the Korkine--Zolotareff theorem~\cite{korkine}. Physics ends at a 
theorem of 1877. Beyond lies pure mathematics, and beyond that: 
