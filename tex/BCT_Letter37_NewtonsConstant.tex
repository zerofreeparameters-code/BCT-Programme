...
$m_P$ & $1.2185\times10^{22}\ \mathrm{MeV}$ & $1.2209\times10^{22}\ \mathrm{MeV}$ \\
$m_P$ error & $-0.20\%$ & — \\
$G_N$ & $6.736\times10^{-45}\ \mathrm{MeV}^{-2}$ & $6.709\times10^{-45}\ \mathrm{MeV}^{-2}$ \\
$G_N$ (SI) & $6.697\times10^{-11}\ \mathrm{m^3kg^{-1}s^{-2}}$ & $6.674\times10^{-11}$ \\
$G_N$ error & $+0.40\%$ & — \\
\bottomrule
\multicolumn{3}{l}{$^\dagger S^{\rm obs}_{\rm QCD} = \ln(m_P/\Lambda_{\rm QCD}) = 45.4628$.}
\end{tabular}
\end{table}
...
\begin{equation}
  \frac{m_P}{\Lambda_{\rm QCD}} = \exp\!\left[\frac{\pi^5}{6}
    \!\left(1 - \frac{\sqrt{6}-2}{4} + \frac{r_{\rm oct}(\sqrt{6}-2)}{4\pi}\right)\right]
...
$\Downarrow$\\
$G_N = 1/m_P^2 \quad \alpha_{\rm EM} \quad G_F \quad \alpha_s$\\
$\Downarrow$\\
