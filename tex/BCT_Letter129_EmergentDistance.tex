...
The answer: because the D4 lattice is the densest \emph{lattice}
sphere packing in four dimensions (Korkine--Zolotareff
1877~\cite{korkine}), and that packing has exactly this void
structure.
