...
$n_T$ & $-r/8{=}{-}4.96\!\times\!10^{-4}$ & unconstrained & — \\
...
\begin{align}
  ...
  E_{\rm inf} &= m_P\,e^{-S_{D4}r_{\rm tet}} \quad\text{[App.~CT]} \label{eq:Einf} \\
  m_P &= \Lambda_{\rm QCD}\,e^{S_{\rm QCD}} \quad\text{[L37]} \label{eq:mP}
\end{align}
