...
Lorentz $\to$ $\sqrt{2}$ $\to$ D4 $\to$ Korkine--Zolotareff $\to$
condensation,
...
\subsection{Step 3: D4 $\Rightarrow$ Densest Lattice Packing (Korkine--Zolotareff)}

The $D_4$ packing is the densest \emph{lattice} sphere packing in four
dimensions. This was proved by Korkine and
Zolotareff~\cite{korkine} in 1877:

\textbf{Theorem} (Korkine--Zolotareff, 1877): \textit{The $D_4$ lattice
achieves the densest lattice sphere packing in $\mathbb{R}^4$.}

The \emph{unrestricted} sphere packing problem in $\mathbb{R}^4$, which
admits non-lattice packings, remains open. The densest packing is known
only in dimensions 1, 2, 3, 8 and 24.
...
\begin{equation}
  ...
  \;\Rightarrow\;
  \underbrace{\text{Korkine--Zolotareff}}_{\text{1877}}
  \;\Rightarrow\;
...
The chain terminates at the Korkine--Zolotareff theorem --- pure
mathematics.
...
The view from the top of the chain is the Korkine--Zolotareff theorem.
...
\textit{Sur les formes quadratiques positives},
Math.\ Ann.\ \textbf{11}, 242 (1877).
[$D_4$ is the densest \emph{lattice} packing in $\mathbb{R}^4$;
the unrestricted packing problem in $\mathbb{R}^4$ remains open.]
...
\paragraph{D4 $\Rightarrow$ Densest Lattice Packing.}
\textit{The Korkine--Zolotareff theorem~\cite{korkine}.}
The $D_4$ lattice is the densest \emph{lattice} packing in
$\mathbb{R}^4$, established by Korkine and Zolotareff in 1877 using
the reduction theory of positive quadratic forms. It is not a BCT
result --- it is an established mathematical theorem. (The analogous
results in dimensions~8 and~24, due to Viazovska and to Cohn, Kumar,
Miller, Radchenko and Viazovska, concern $E_8$ and the Leech lattice
...
\begin{enumerate}
  ...
  \item That physics is the only possible mathematics. The chain
    ends at the Korkine--Zolotareff theorem. Why that theorem is true --- why
...
is to correctly identify where physics ends: at the
Korkine--Zolotareff theorem. Beyond that point, the question is about the nature
