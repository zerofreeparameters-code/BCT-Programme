...
\begin{equation}
\mathcal{B} = I(x,y)\cdot\frac{j_{1,1}}{j_{2,1}}
= 0.6276\cdot I(x,y)
\end{equation}
...
\begin{center}
{\small
\begin{tabular}{p{1.6cm}p{2.1cm}p{2.0cm}p{1.3cm}}
\hline\hline
