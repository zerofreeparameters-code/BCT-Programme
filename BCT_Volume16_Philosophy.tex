...
\begin{enumerate}
  ...
  \item \textit{The limits of physics:} BCT correctly identifies its
        own boundary: Viazovska's theorem is the last step physics can
...
BCT identifies the correct boundary: physics ends at Viazovska's
theorem (Letter~128). Mathematics ends at G\"odel. Silence begins
