...
\usepackage{amsmath,amssymb,amsfonts,xcolor,booktabs,microtype,hyperref,graphicx}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{BCT_DreamHypothesis_Result}
\caption{Infra-slow PSD by sleep stage (left) and power at BCT
Josephson frequency $\fJ = 0.08979$~Hz per stage (right).
REM shows elevated power vs N2 ($p=0.001$, ratio 1.19).
Data: Sleep-EDF Expanded, $n=5$ subjects, 863 REM epochs.
Red dashed line marks $\fJ$. Error bars = SEM.}
\label{fig:rem}
\end{figure}
