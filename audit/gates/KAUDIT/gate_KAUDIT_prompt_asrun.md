% AS-RUN record for Gate KAUDIT
% Executing model: Claude Opus 4.8 (Anthropic)
% Executed: 15 September 2026
% Prompt SHA-256 (verified against pre-registration): c6da27858da0d675cf525df68a882c45055234a3ce3d22dc1b76367176f0a0e1
% Prompt size: 9678 bytes
% The exact prompt text as received follows verbatim.
% ---------------------------------------------------------------
